...
double AvoidObstacles::CorrectionAmount() {
  double NGCAdjacentSide = NGCDistance() * cos(NGCAngle() * Constants::degreesToRadians);
  double horizontalCorrection = Constants::obstacleDistance - horizontalDistance;
  double angleCorrection = atan(horizontalCorrection/NGCAdjacentSide) / Constants::degreesToRadians;
