...
void OI::MapControllerButtons() {
  ...
  //Driver Controller
    ...
    frc2::Button([this] { return driverController->GetRawButton(Xbox::A_button); }).WhileHeld(new IntakePowerCell());
  ...
  //Manipulator Controller
    ...
    frc2::Button([this] { return manipulatorController->GetRawBut,ton(Xbox::B_button); }).WhenPressed(new AimShooterDown());
